...
- The model leverages multiple frames for temporal context to improve detection performance
- The OpenContrails dataset contains human-labeled contrail detections from the GOES-16 satellite
- The authors present the OpenContrails dataset and model as public benchmarks
- This work involves contributors from Google's Research Department and MIT's Laboratory for Aviation and the Environment

Optimizing satellite imagery, [GOES-R ABI](https://www.goes-r.gov/multimedia/instr-Abi.html), and advanced computer vision for accurate detection of contrails.
...
<img src="documentation/images/research/detected-contrails-flights.png" width="500">
...
#### Dataset description:
OpenContrails is a dataset of contrail detections from GOES-16 Advanced Baseline Imager data. It was created to train models for contrail detection and climate impact assessment.
...
- Images are derived from GOES-16 ABI in geostationary orbit
- Covers the North and South American region with 10-minute interval images since April 2019
- Examples generated by random sampling of GOES-16 viewable extent from April 2019-2020
- Samples restricted within -50 to 50-degree latitude and -135 to -30-degree longitude
- Contrail detection model uses deep neural networks, including ResNet and DeeplabV3+ architectures
---
...
---
##### 🔢  google storage [gcp-public-data-goes-16]( https://console.cloud.google.com/storage/browser/gcp-public-data-goes-16;tab=objects?prefix=&forceOnObjectsSortingFiltering=false)
...
##### ☛ [catalogues of atmospheric optics (rocket plume, contrail shadow)](https://atoptics.co.uk/atoptics/shuttle.htm), [shuttle plume shadow](https://atoptics.co.uk/atoptics/contr1.htm)
